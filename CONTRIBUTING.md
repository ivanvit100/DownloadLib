...
│   ├── ImageCompressor.js   # Сжатие изображений через canvas с минимальной потерей качества
│   └── PluginManager.js     # Управление пользовательскими плагинами (сервисы и экспортёры)
...
- [x] Реализовать систему плагинов для Firefox
- [x] Реализовать пример плагина-формата
- [x] Реализовать пример плагина-сервиса
