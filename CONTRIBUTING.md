...
- [ ] Исправление отображения кнопки на сайте на маленьких экранах
- [ ] Реализация истории загрузок
- [ ] Поддержка HTML в EPUB и FB2
- [ ] Реализация механизма оповещения при изменении API
- [ ] Рефакторинг фоноывх скриптов
- [ ] Рефакторинг PopupController
- [ ] Глобальный тест всего существующего функционала в Firefox для Android
