...
- [x] Настройка селктора главы/тома (1.0.10)
- [x] Смысловой обрыв файла по загруженному тому (1.0.10)
- [x] Апгрейднуть паузу (1.0.10)
- [x] Починить отображение сервиса-плагина в истории (1.0.10)
- [x] Помечать самый длинный перевод (1.0.10)
- [x] Поддержка gif в RanobeLib (1.0.10)
- [ ] Ускорение загрузки временным скипом "завсиших" глав (1.1.0)
- [ ] Общий рефакторинг архитектуры (1.1.0)
- [ ] Полное покрытие методов jsDoc (1.1.0)
- [ ] e2e тесты (1.1.0+)
- [ ] Добавить возможность выбора сервера (ожидание API)
