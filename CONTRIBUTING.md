...
- [x] Настройка селкктора главы/тома
- [x] Смысловой обрыв файла по загруженному тому
- [ ] Апгрейднуть паузу
- [ ] Починить отображение сервиса-плагина в истории
- [x] Помечать самый длинный перевод
- [x] Поддержка gif в RanobeLib
