...
#### Браузерное расширение для загрузки манги | v1.0.5
...
- **Выбор формата файла**
  ...
  - MOBI (электронные книги для Amazon)
  - PDF (страницы с текстом и изображениями)
  - TXT (текстовый файл - только для RanobeLib)
  - JPEG (ZIP-архив с картинками - только для MangaLib)
- **Выборочная загрузка**
...
- **Настройка размеров загружаемых файлов**
  - Можно задать размеры загружаемых частей файлов.
- **Интерфейс popup**
...
- **Кнопка загрузки на сайте**
  - Кнопка быстрого скачивания, внедренная на страницу тайтла.
...
- **Chromium-браузеры (Chrome, Edge, Яндекс и др.)** — находится в бета-версии, некоторые функции могут работать непредсказуемо.
...
3. Выберите нужный формат (FB2, EPUB, MOBI, PDF, TXT/JPEG).
4. Установите лимит запросов (по умолчанию 100/мин).
5. Установите целевой размер загружаемых частей в мегабайтах.
6. Нажмите **Скачать книгу**.
